...
$(MEM_1)_START := 0x02004000
$(MEM_1)_END := 0x020043ff
$(MEM_1)_HIERARCHICAL_PATH := manuer_queue
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: manuer_queue
manuer_queue: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
# Memory: state_cmd_memory
MEM_3 := state_cmd_memory
$(MEM_3)_NAME := state_cmd_memory
...
$(MEM_3)_START := 0x02005000
$(MEM_3)_END := 0x020053ff
$(MEM_3)_HIERARCHICAL_PATH := state_cmd_memory
$(MEM_3)_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: state_cmd_memory
state_cmd_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
